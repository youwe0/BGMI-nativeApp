...
export type GunCategory = 'AR' | 'SMG' | 'Shotgun' | 'Pistol' | 'Sniper' | 'LMG' | 'DMR';
...
export const GUNS_BY_CATEGORY: Record<GunCategory, string[]> = {
  AR: ['M416', 'SCAR-L', 'M762', 'AKM', 'Beryl M762', 'MK47 Mutant', 'G36C', 'QBZ95'],
  SMG: ['UMP45', 'PP-19 Bizon', 'MP5K', 'Vector', 'Tommy Gun', 'Micro UZI', 'P90'],
